...
| OpenCode | `.opencode/plugins/ponytail.mjs`, `.opencode/commands/`, `hooks/`, `skills/` | Server plugin injects the ruleset each turn, registers commands, and persists `/ponytail` switches; reuses the shared instruction builder. |
