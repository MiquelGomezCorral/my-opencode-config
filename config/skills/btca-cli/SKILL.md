...
- Providers supported: opencode, anthropic, openai, openai-compat, github-copilot, google, openrouter, minimax.
- Environment variable overrides: `OPENCODE_API_KEY`, `OPENROUTER_API_KEY`, `MINIMAX_API_KEY`.
